import type { Stock, Position, Order, PortfolioSummary, MarketIndex, KLineData } from '../types';
...
function generateKLineData(basePrice: number, days: number = 30): KLineData[] {
...
const mockOrders: Order[] = [
  { id: 'ORD20240115001', symbol: 'SH600519', name: '贵州茅台', type: 'buy', price: 1620.00, quantity: 100, amount: 162000, status: 'filled', createTime: '2024-01-15 09:35:22' },
  { id: 'ORD20240120002', symbol: 'SZ000858', name: '五粮液', type: 'buy', price: 148.00, quantity: 500, amount: 74000, status: 'filled', createTime: '2024-01-20 14:20:15' },
  { id: 'ORD20240201003', symbol: 'SZ300750', name: '宁德时代', type: 'buy', price: 235.00, quantity: 300, amount: 70500, status: 'filled', createTime: '2024-02-01 10:05:33' },
  { id: 'ORD20240210004', symbol: 'SH600036', name: '招商银行', type: 'buy', price: 33.50, quantity: 2000, amount: 67000, status: 'filled', createTime: '2024-02-10 09:32:10' },
  { id: 'ORD20240215005', symbol: 'SZ002594', name: '比亚迪', type: 'buy', price: 230.00, quantity: 200, amount: 46000, status: 'filled', createTime: '2024-02-15 11:15:47' },
  { id: 'ORD20240301006', symbol: 'SZ300750', name: '宁德时代', type: 'sell', price: 228.00, quantity: 100, amount: 22800, status: 'filled', createTime: '2024-03-01 14:45:28' },
];
...
export const api = {
  ...
  getKLineData: async (symbol: string): Promise<KLineData[]> => {
    await delay(300);
    const stock = mockStocks.find(s => s.symbol === symbol) || mockStocks[0];
    return generateKLineData(stock.price);
  },
};
