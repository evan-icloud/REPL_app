// Patch react-native-svg in Taro project to use View-based stubs for fabric view managers
// This avoids codegenNativeComponent issues on Paper renderer
const fs = require('fs');
const path = require('path');

const fabricDir = 'D:/safe/invest-app-taro/node_modules/react-native-svg/lib/commonjs/fabric';
